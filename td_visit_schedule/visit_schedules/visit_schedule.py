...
from .schedules.maternal import antenatal_membership_schedule_v3

from .schedules.maternal import maternal_labour_schedule_v1
...
maternal_enrollment_visit_v3 = VisitSchedule(
    name='maternal_enrollment_visit_schedule_v3',
    verbose_name='Maternal Enrollment Visit Schedule v3',
    offstudy_model=f'td_maternal.maternaloffstudy',
    death_report_model=f'',
    locator_model='edc_locator.subjectlocator',
    previous_visit_schedule=None
)
maternal_enrollment_visit_v3.add_schedule(maternal_enrollment_visit_v3)
