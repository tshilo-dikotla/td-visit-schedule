...
infant_crf_2010 = FormsCollection(
    ...
    Crf(show_order=12, model='td_infant.infantcliniciannotes'),
...
infant_crf_2020 = FormsCollection(
    ...
    Crf(show_order=11, model='td_infant.infantcliniciannotes'),
...
infant_crf_2060 = FormsCollection(
    ...
    Crf(show_order=10, model='td_infant.infantcliniciannotes'),
...
infant_crfs_unscheduled = FormsCollection(
    Crf(show_order=1, model='td_infant.infantcliniciannotes'),
    name='unscheduled',
)
